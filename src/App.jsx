      ...
      <section className="hero" id={t.nav[0]}>
        <div className="hero-content">
          ...
          <h1 className="hero-title">
             ...
             */}
             <span>
  <span className="kishori-text">KISHORI</span> 
  
  <span className="swasthya-text">SWASTHYA</span>
</span>
          </h1>
          {/* <img src="/assets/keep-her-smiling.png" alt="tagline" className="tagline-img" /> */}
          {/* <h2>Keep Her Smiling</h2> */}
          {/* <p className="tagline-text">Keep Her Smiling</p> */}
          {/* <h2>{t.heroSub}</h2> */}
          {/* <p>{t.heroText}</p> */}
          <h2>{t.heroSub}</h2>
          <p>{t.heroText}</p>
      ...
      <section className="voucher-section">
        <div className="section-heading">
           ...
           */}
           <img
  src={ASSETS.bataHeroLogo}
  alt="Bata"
  className="voucher-bata-logo"
/>
        </div>
